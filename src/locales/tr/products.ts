...
export const productsType = {
  ...
  'products.hydraulicSystem': 'HİDROLİK HORTUM',
  'products.hydraulicHose': 'HİDROLİK HAT BORULARI',
  ...
  'products.hydraulicSystem.desc': 'Yüksek basınç altında çalışan sistemler için tasarlanmış esnek ve dayanıklı hortumlardır.',
  'products.hydraulicHose.desc': 'Endüstriyel ve tarımsal makinelerde kullanılan dayanıklı hidrolik borulardır.',
